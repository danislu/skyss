...
var _travelmagic = require('./../server/travelmagic');
...
describe('testing travelmagic api', function () {
    ...
    it('api test 1', function (done) {
        return (0, _travelmagic.getNextDeparturesFromGeoToLocation)({ lat: latLng.y, lng: latLng.x }, dkPlassStopName).then((0, _utils.asyncCatch)(function (value) {
            (0, _chai.expect)(value.length).to.be.equal(10);
        }, done)).catch(done);
    });
});
//# sourceMappingURL=travelmagic.test.js.map
